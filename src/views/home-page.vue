<template>
  <div>
    ...
    <div class="section">
      <section class="section-container" v-bind:class="{ 'section-container_hide': !isVisibleMenu }">
        <div class="section__btn_close" v-on:click="isVisibleMenu = !isVisibleMenu">
          <div class="p-icon p-icon-chevron-left" v-bind:class="{ 'section__btn_close_rotate': isVisibleMenu }" />
        </div>
